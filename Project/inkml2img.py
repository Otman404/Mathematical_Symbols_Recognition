...
def get_label(inkml_file_abs_path):
	...
	# print(type(doc_namespace), doc_namespace)

	for child in root:
		# print("child: ", child, child.tag, child.attrib, child.text)
		print("child: ", child.keys(), child.tag, child.text)
